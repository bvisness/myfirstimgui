...
func main() {
	...
	texture, err := newTexture("calvinboom.png")
	if err != nil {
		panic(err)
	}
...
func initGlfw() *glfw.Window {
	...
	window, err := glfw.CreateWindow(500, 500, "My first IMGUI", nil, nil)
	if err != nil {
		panic(err)
	}
...
func newProgram(v, f string) (uint32, error) {
	vertexShader, err := compileShader(v, gl.VERTEX_SHADER)
	if err != nil {
		return 0, err
	}

	fragmentShader, err := compileShader(f, gl.FRAGMENT_SHADER)
	if err != nil {
		return 0, err
	}
